...
<body>
    ...
    <form class="w3-container" method="post" action="atividadeOnlineAction.php">
        ...
        <input class="w3-input w3-border w3-light-grey" name="valorcompra" type="number">

        <label class="w3-text-teal"><b>Escolha a forma de Pagamento:</b></label>
        <select class="w3-input w3-border w3-light-grey"  name = "forma">
        <option value="cartaoCredito">Cartão de Crédito</option>
        <option value="boleto">Boleto</option>
        <option value="deposito" selected>Depósito</option></select>
